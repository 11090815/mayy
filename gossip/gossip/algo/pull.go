...
func NewPullEngineWithFilter(adapter PullAdapter, sleepTime time.Duration, dFilter DigestFilter, config PullEngineConfig) PullEngine {
...
func NewPullEngine(adapter PullAdapter, sleepTime time.Duration, config PullEngineConfig) PullEngine {
	...
	return NewPullEngineWithFilter(adapter, sleepTime, dFilter, config)
}
